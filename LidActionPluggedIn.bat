...
echo %GREEN%Current lid close action when plugged in: %RED%!status!%RESET%
echo %CYAN%===============================================%RESET%
echo %YELLOW%Select new lid close action (PLUGGED IN):%RESET%
echo 1 - Do Nothing
echo 2 - Sleep
echo 3 - Hibernate
echo 4 - Shut Down
...
echo %BLUE%Applying your choice for PLUGGED IN...%RESET%

powercfg /setacvalueindex SCHEME_CURRENT SUB_BUTTONS LidAction !action!
powercfg /S SCHEME_CURRENT

echo %GREEN%Lid close action for PLUGGED IN updated successfully.%RESET%
pause
